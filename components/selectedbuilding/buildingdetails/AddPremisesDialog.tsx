...
export const AddPremisesDialog: React.FC<Props> = ({ buildingId, premises }) => {
    /* const [open, setOpen] = React.useState(false); */

    console.log(premises)

    const dispatch = useAppDispatch()
    const addPremisesDialogOpen = useAppSelector((state) => state.navigation.addPremisesDialogOpen)


    const handleClose = () => {
        dispatch(navigationSlice.actions.setAddPremisesDialog(false))
        setPremisesDetails({
            name: "",
            floor: "",
            type: "",
                ...
                return (
                    <StyledPremisesDetails>
                        ...
                        {/* <StyledTextInput
                            ...
                            label="Parking Ratio"
                            variant="outlined"
                            onChange={handleParkingRatioChange}
    ...
    return (
        <div>
            ...
            <Dialog
                ...
                closeAfterTransition={true} open={addPremisesDialogOpen} onClose={handleClose}
                TransitionProps={{
                    onExited: () => {
            ...
            >
                <DialogTitle>Add Premises</DialogTitle>
                <DialogContent>
